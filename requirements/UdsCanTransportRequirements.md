...
The UDS CAN transport component shall connect the existing UDS transport and
ISO-TP layers to VirtualCanBus.

This stage introduces simulated CAN transmission of diagnostic request and
response frames.
...
The following functionality remains outside this stage:

- Runtime integration into SimulationEngine
...
The architecture verified by this requirement set shall be:
